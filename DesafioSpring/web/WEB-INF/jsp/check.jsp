...
<html>
    <head>
        ...
        <script>
            function num_input(){
                ...
                while(cont<num){
                    $("#respuest").append("<div class='form-check'><input type='checkbox' name='res' value='"+cont+"' class='form-check-input'><input type='text' value='' name='preg"+cont+"' id='"+cont+"' class='form-control' requiered><br></div>");
                    cont++;
                }
        ...
        <div class="jumbotron text-center" style="height: 30px; background-color: #6C3483; color: white;">
            <div class="row">
                <div class="col-8 offset-2">
                    <h1>PREGUNTA CON VARIAS RESPUESTAS</h1></div>
                <div class="col-2">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
            <form name="formulario" action="check.htm" method="POST">
